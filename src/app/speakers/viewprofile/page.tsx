...
export default function SpeakerProfileView() {
    ...
    <div className="relative bg-white border border-gray-300 rounded-2xl shadow-lg p-10 w-full max-w-6xl mb-16">
      <div className="absolute top-4 right-4 flex gap-2">
        <button
          ...
          className="p-2 bg-red-600 text-white rounded-md shadow hover:bg-red-700"
        >
          <svg
        ...
        <button
          ...
          className="p-2 bg-gray-800 text-white rounded-md shadow hover:bg-gray-900"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
        ...
        <div>
          <p className="font-bold p-1">Role</p>
          <p className="px-4 py-2 border border-gray-200 rounded-lg text-sm text-gray-800 bg-gray-50">
            Participant
          </p>
        </div>
  ...
  <button
    ...
    className="bg-red-300 text-white px-4 py-2 rounded-lg hover:bg-green-700"
  >
    Go to Participant Home
  </button>
</div>
